  ...
  const ReceiptContent = ({ type }: { type: "kitchen" | "expedition" }) => (
    <div className="p-3 text-xs font-mono text-black bg-white">
      ...
      <div className="text-xs">
        ...
        <p>
          <strong>Cliente:</strong> {order.user.name.toUpperCase()}
        </p>
          ...
          <div className="text-xs">
            ...
            {order.paymentMethod === "CASH" &&
              ...
              order.changeFor != null && (
                <p>
                  <strong>Troco para:</strong> {currencyFormat(order.changeFor)}
                </p>
              )}
          </div>
        </>
        ...
        <>
          ...
          <div className="text-xs mt-1 space-y-0.5">
            ...
            <div className="flex justify-between font-bold text-sm mt-1">
              ...
              <span>
                {currencyFormat(
                  order.total + (order.isDelivery ? order.deliveryFee || 0 : 0)
                )}
              </span>
            </div>
          </div>
